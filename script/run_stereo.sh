...
source /root/zhikang.zeng/work_humble_ws_x5/tros_ws/install/setup.bash
#source /root/zhikang.zeng/install/setup.bash
...
mipi_image_width:=$mipi_image_width mipi_image_height:=$mipi_image_height mipi_image_framerate:=$mipi_image_framerate mipi_rotation:=$mipi_rotation \
mipi_gdc_enable:=$mipi_gdc_enable mipi_lpwm_enable:=$mipi_lpwm_enable mipi_frame_ts_type:=realtime \
...
save_result_flag:=$save_result_flag save_dir:=$save_dir save_freq:=$save_freq save_total:=$save_total save_pcd_flag:=$save_pcd_flag \
infer_thread_num:=$infer_thread_num save_thread_num:=$save_thread_num \
