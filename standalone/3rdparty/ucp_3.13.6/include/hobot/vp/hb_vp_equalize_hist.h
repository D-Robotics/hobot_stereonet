...
#ifndef VP_HB_VP_EQUALIZE_HIST_H_
#define VP_HB_VP_EQUALIZE_HIST_H_
 ...
 */
int32_t hbVPEqualizeHist(hbUCPTaskHandle_t *taskHandle, hbVPImage *dstImg,
...
#endif  // VP_HB_VP_EQUALIZE_HIST_H_
