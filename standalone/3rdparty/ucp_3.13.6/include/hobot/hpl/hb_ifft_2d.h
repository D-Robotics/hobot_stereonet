...
#ifndef HPL_HB_IFFT_2D_H_
#define HPL_HB_IFFT_2D_H_
...
/**
 * ifft2d parameter, be the same as fft2d parameter
...
/**
 * @brief IFFT operator on 2d complex data for type hbHPLImaginaryData
 * 
 ...
 * @param[in] param param for IFFT2D
